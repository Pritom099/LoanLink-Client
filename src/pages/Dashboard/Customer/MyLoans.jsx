        ...
        <div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 p-5">
                ...
                <div className="card bg-base-100  border border-gray-300 rounded-2xl p-6">
                    <h2 className="card-title mb-4 text-lg">Total Applications</h2>
                    <p className="text-4xl font-bold">5</p>
                </div>
                <div className="card bg-base-100  border border-gray-300 rounded-2xl p-6">
                    <h2 className="card-title mb-4 text-lg">Approved</h2>
                    <p className="text-4xl font-bold text-green-600">4</p>
                </div>
                <div className="card bg-base-100  border border-gray-300 rounded-2xl p-6">
                    <h2 className="card-title mb-4 text-lg">Pending Review</h2>
