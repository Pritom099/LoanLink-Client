const Banner1 = () => {
    return (
        <div>
            <div className="flex flex-col justify-center items-center gap-4  bg-base-200 py-20">
            ...
            <div className="grid grid-cols-3 p-20 text-center border-t mx-auto max-w-7xl">
                <div>
